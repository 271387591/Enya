...
androidQr=function(){
    $.get(appPath+'html/appstore/getQr',{},function(result){
        if(result.success){
            var data=result.data;
            $('#androidQr').html('<img src="'+data.qrUrl+'"/>');
            $('#androidPac').html('<a target="_blank" class="btn btn-default" href="'+data.pacUrl+'">下载至电脑</a>');
        }
    });
}
