        ...
        <div class="right-content" >
            <div class="table-box">
                ...
                <div class="table-title">
                    <h5>展会排序<span class="green">(只支持前20位排序)</span></h5>
                    <div class="pull-right">
                        <a type="button" class="btn btn-primary" onclick="reloadPage('html/exhibition/security/index');">
                            <span>返回</span>
                        </a>
                    </div>
                </div>
...
<script src="<c:url value="/resources/js/admin/exh/exhibition.js"/>"></script>
<script type="text/javascript">
    jQuery(function($) {
        changeMenu($('#menu-exhibition'));
