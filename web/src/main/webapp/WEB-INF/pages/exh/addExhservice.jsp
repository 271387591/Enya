...
<head>
    ...
    <title>${command.id==null?'添加服务':'编辑服务'}</title>
...
<div id="right-box" class="right-box">
    ...
    <div id="mainContent">
        <ul class="breadcrumb">
            <li><a href="javascript:void(0);" onclick="reloadPage('html/exhService/security/index');">会展服务管理</a></li>
            <li class="active"><i class="icon-user"></i>${command.id==null?'添加服务':'编辑服务'}</li>
        </ul>
        <div class="right-content" id="right-content">
            <div class="content-title">
                <ul>
                    <li><h5>${command.id==null?'添加服务':'编辑服务'}</h5></li>
                </ul>
            ...
            <div class="content-box">
                <form class="form-horizontal padding-10" id="userForm">
                    ...
                    <div class="form-group">
                        <label class="col-sm-1 control-label">服务内容</label>
                        <div class="col-sm-11">
