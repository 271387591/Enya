        ...
        <div class="right-content" >
            <div class="table-box">
                ...
                <div class="table-title">
                    <h5>新闻排序<span class="green">(只支持前20位排序)</span></h5>
                    <div class="pull-right">
                        <a type="button" class="btn btn-primary" onclick="reloadPage('html/exhNews/security/index');">
                            <span>返回</span>
                        </a>
                    </div>
                </div>
...
<script src="<c:url value="/resources/js/admin/exh/exhNews.js"/>"></script>
<script type="text/javascript">
    jQuery(function($) {
        changeMenu($('#menu-exhnews'));
