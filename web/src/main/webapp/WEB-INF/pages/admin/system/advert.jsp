        ...
        <div class="main-content" id="mainContent">
            <div class="breadcrumbs" id="breadcrumbs">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active"><i class="icon-user"></i>广告管理</li>
                </ul>
            </div>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="table-title">
                            <span style="margin-left: 10px" class="green">广告列表</span>
...
<script type="text/javascript" src="<c:url value="/resources/js/admin/system/advert.js"/>"></script>
<script type="text/javascript">
    jQuery(function($) {
        changeNav('menu-advert');
        listTable();
    });
</script>
</body>
